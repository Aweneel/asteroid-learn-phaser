# Asteroid game using Phaser React TypeScript Template

This is a game developed to learn phaser 3 game development framework. The game is very simplistic and uses basic concepts of phaser js. The game was developed on top of phaser 3 project template. Everything below is part of the readme file from the original template project.

The Phaser 3 project template that uses the React framework and Vite for bundling. It includes a bridge for React to Phaser game communication, hot-reloading for quick development workflow and scripts to generate production-ready builds.
